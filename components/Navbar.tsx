  ...
  return (
    <header className="sticky top-0 z-50 bg-[#F5F1EA] border-b border-[#16130F]/10">
      ...
      >
        ...
        >
          <span className="block w-5 h-px bg-current mb-1.5 transition-transform duration-200" />
          <span className="block w-5 h-px bg-current mb-1.5 transition-opacity duration-200" />
        ...
        {menuOpen && (
          ...
          >
            <ul className="flex flex-col px-6 py-4 gap-1" role="list">
                  ...
                  <li key={link.href}>
                    {link.type === "anchor" ? (
                      <Link
                        ...
                        className="block py-2.5 text-[14px] text-[#16130F]/70 hover:text-[#16130F] transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1F3AA8] rounded-sm"
                      >
                        {link.label}
                      </Link>
                    ) : (
                      <Link
                        ...
                        className={`block py-2.5 text-[14px] transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1F3AA8] rounded-sm ${
                          isActive
                            ? "text-[#1F3AA8] font-medium"
                            : "text-[#16130F]/70 hover:text-[#16130F]"
                        }`}
              ...
              <li className="pt-3 border-t border-[#16130F]/10 mt-2">
                <Link
                  href="/swap-listing"
                  onClick={() => setMenuOpen(false)}
                  className="block py-2.5 text-[14px] text-[#1F3AA8] font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1F3AA8] rounded-sm"
                >
                  List your project
                </Link>
              </li>
